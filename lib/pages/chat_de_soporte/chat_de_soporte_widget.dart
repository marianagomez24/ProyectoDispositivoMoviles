...
import 'chat_de_soporte_model.dart';
export 'chat_de_soporte_model.dart';

class ChatDeSoporteWidget extends StatefulWidget {
  const ChatDeSoporteWidget({super.key});

  @override
  State<ChatDeSoporteWidget> createState() => _ChatDeSoporteWidgetState();
}

class _ChatDeSoporteWidgetState extends State<ChatDeSoporteWidget> {
  late ChatDeSoporteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatDeSoporteModel());
