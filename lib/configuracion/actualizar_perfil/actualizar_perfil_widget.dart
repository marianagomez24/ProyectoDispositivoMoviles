  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> actualizarPerfilUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final actualizarPerfilUsersRecord =
            actualizarPerfilUsersRecordList.isNotEmpty
                ? actualizarPerfilUsersRecordList.first
                : null;
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller: _model.textController1 ??=
                                  ...
                                  text:
                                      actualizarPerfilUsersRecord?.displayName,
                                ),
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController2 ??=
                              TextEditingController(
                            text: actualizarPerfilUsersRecord?.cedula,
                          ),
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController3 ??=
                              TextEditingController(
                            text: actualizarPerfilUsersRecord?.direccion,
                          ),
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController4 ??=
                              TextEditingController(
                            text: actualizarPerfilUsersRecord?.sexo,
                          ),
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await widget.user!.reference.update(createUsersRecordData(
                      ...
                      cedula: _model.textController2.text,
                      direccion: _model.textController3.text,
                      sexo: _model.textController4.text,
                    ));
                  },
