...
class CitasAntiguasRecord extends FirestoreRecord {
  CitasAntiguasRecord._(
    super.reference,
    super.data,
  ) {
    _initializeFields();
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('citasAntiguas');

  static Stream<CitasAntiguasRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => CitasAntiguasRecord.fromSnapshot(s));

  static Future<CitasAntiguasRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => CitasAntiguasRecord.fromSnapshot(s));

  static CitasAntiguasRecord fromSnapshot(DocumentSnapshot snapshot) =>
      CitasAntiguasRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static CitasAntiguasRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      CitasAntiguasRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'CitasAntiguasRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is CitasAntiguasRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createCitasAntiguasRecordData({
...
class CitasAntiguasRecordDocumentEquality
    implements Equality<CitasAntiguasRecord> {
  const CitasAntiguasRecordDocumentEquality();

  @override
  bool equals(CitasAntiguasRecord? e1, CitasAntiguasRecord? e2) {
  ...
  @override
  int hash(CitasAntiguasRecord? e) => const ListEquality().hash([
        e?.especialidadCita,
        e?.nombreUsuario,
  ...
  @override
  bool isValidKey(Object? o) => o is CitasAntiguasRecord;
}
